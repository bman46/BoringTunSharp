...
Instead, please send an email to the address in [@bman46's bio](https://github.com/bman46) or on [GitHub Security Reporting](https://github.com/bman46/BoringTunSharp/security/advisories/new).
